...
<ComponentPreview className='gap-6 items-start'>
  <Tilt rotationFactor={15} springOptions={{ stiffness: 300, damping: 20 }}>
    <Card className='w-60 overflow-hidden'>
      <div className='relative h-40'>
        <DepthMedia src='https://picsum.photos/240/160' alt='Low intensity' depthIntensity={4} />
      </div>
  ...
  <Tilt rotationFactor={15} springOptions={{ stiffness: 300, damping: 20 }}>
    <Card className='w-60 overflow-hidden'>
      <div className='relative h-40'>
        <DepthMedia src='https://picsum.photos/242/162' alt='High intensity' depthIntensity={16} />
      </div>
      <CardContent className='py-3'>
