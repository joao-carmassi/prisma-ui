...
export const metadata = {
  ...
  description:
    'A unified ambient glow wrapper with aura, beam, and shine variants. Use variant="aura" for a diffuse halo, variant="beam" for a focused travelling arc, or variant="shine" for a sweeping radial highlight — all with the same high-quality blur and glow layers.',
...
| ------------- | --------------------- | ----------- | ---------------------------------------------------------------------- |
| `variant`     | `"aura" \| "beam" \| "shine"` | `"aura"` | Visual variant                                                   |
