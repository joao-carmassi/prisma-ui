...
function FloatingLabelText({
  ...
  return (
    <Label
      className={cn(
        'absolute inset-s-0 top-0.5 z-10 origin-left -translate-y-1 scale-75 transform bg-transparent px-0 text-sm leading-none [&>p]:m-0 [&>p]:leading-none text-muted-foreground duration-300',
        'peer-placeholder-shown:top-5 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-x-0',
        'peer-focus:top-0.5 peer-focus:-translate-y-1 peer-focus:scale-75 peer-focus:px-0 peer-focus:text-foreground peer-focus:translate-x-0',
        'cursor-text',
        className,
      )}
      {...props}
