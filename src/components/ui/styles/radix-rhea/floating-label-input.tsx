...
function FloatingLabelText({
  ...
  return (
    <Label
      className={cn(
        'absolute inset-s-2 top-0.5 z-10 origin-left -translate-y-2 scale-75 transform bg-background px-2 text-sm leading-none [&>p]:m-0 [&>p]:leading-none text-muted-foreground duration-300',
